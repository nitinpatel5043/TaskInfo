...
//        /// <summary>
//        /// Register a new user and assign role (Admin or User).
//        /// </summary>
//        [HttpPost("[action]/{roleName}")]
//        public async Task<IActionResult> Register([FromBody] RegisterUser model, [FromRoute] string roleName)
//        {
//            if (!ModelState.IsValid)
//            {
//                return BadRequest(ModelState);
...
//            return Ok(new { message = $"{roleName} registered successfully!" });
//        }
